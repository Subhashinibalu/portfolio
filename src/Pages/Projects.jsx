  ...
  return (
    <div>
      ...
      <div className="bg-blue-100 p-10 md:p-12 lg:p-16  " id="projects">
        <h2 className="text-xl font-bold text-center p-8" data-aos="zoom-in">
          PROJECTS I&apos;VE DONE
        </h2>
        
        <div className="flex justify-around flex-wrap gap-10 md:p-5">
          <div
            className=" w-full md:w-3/4 lg:max-w-sm rounded overflow-hidden shadow-lg"
            data-aos="fade-up"
            data-aos-delay="300"
          >
            <img
        ...
        <div className="flex justify-end items-baseline mt-5 md:mt-0 animate-bounce">
          <a href="#contact" title="contact details">
              ...
              <MdOutlineContactPhone className="text-5xl font-thin text-gray-500" />
